...
INSERT INTO 'prestamos' ('id_prestamo','id_libro','id_estudiante','fecha_retiro','fecha_entrega') VALUES
(1,4,1,'2021-07-08','2021-8-1'),
(2,6,4,'2021-07-20','2021-8-5'),
(3,7,6,'2021-08-10','2021-9-20'),
(4,9,22,'2021-09-10','');
...
--
ALTER TABLE 'prestamos'
  MODIFY 'id_prestamo' int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
